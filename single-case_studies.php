    ...
    <div class="container_12">
        <div class="grid_12">
            <nav class="breadcrumbs">
                <ul>
                    <li class="home">
                        <a href="http://www.deuren.co.uk/" title="Go to Home Page">Home</a> <span>&#124;</span>
                    </li>
                    <li class="cms_page"><strong><?php echo theme('title'); ?></strong></li>
                </ul>
            </nav>
        </div>
        <div class="clear"></div>
                ...
                <div class="std">
                    <div class="cms-page-portfolio-detail" id="cms-page-portfolio-detail">
                        <div class="slide-portfolio">
                            ...
                            <div><img src="<?php echo $image['url']; ?>"></div><?php endforeach;?><?php endif;?>
                        </div>
                        <div class="portfolio-detail-content">
                            <div class="row">
                                ...
                                <div class="portfolio-left small-12 medium-8 columns">
                                    <p class="portfolio-subcribe"><?php echo theme('body'); ?></p><a class="button" href="/case-studies"><?php echo theme('button'); ?></a>
                                </div>
                                <div class="portfolio-right small-12 medium-4 columns">
                                    <div class="box-info">
                                        <ul>
                                            ...
                                            <li><span class="sub-title"><?php echo theme('widget_title'); ?></span> <span class="sub-info"><a href='<?php echo theme("url");?>'> <?php echo theme('widget_text'); ?></a></span></li><?php $i++;endwhile;endif;?>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( get_the_title() ); ?>" class="hover">
                                    <div class="small-6 medium-4 columns fs-slide">
                                        <div class="fss-wrapper">
                                            <div class="fs-image"><img src="<?php echo get_the_post_thumbnail_url( get_the_ID(), 'inspiration-preview' ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>"  />
</div>
                                            <div class="image-overlay">
                                                <div class="image-overlay-wrapper">
                                                    <div class="image-overlay-center">
                                                        <p class="middle-text"><?php the_title();?>
